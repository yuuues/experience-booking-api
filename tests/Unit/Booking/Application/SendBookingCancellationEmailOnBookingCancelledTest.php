...
use App\Booking\Application\Notify\SendBookingCancellationEmailOnBookingCancelled;
...
final class SendBookingCancellationEmailOnBookingCancelledTest extends TestCase
{
    private InMemoryMailer $mailer;
    private SendBookingCancellationEmailOnBookingCancelled $handler;
    private BookingCancelled $event;
    ...
    protected function setUp(): void
    {
        ...
        $this->handler = new SendBookingCancellationEmailOnBookingCancelled(
            new FakeUserContactProvider(),
            $sessions,
            $this->mailer,
            new InMemorySentNotificationRegistry(),
        );
        $this->event = new BookingCancelled(
    ...
    #[Test]
    public function it_sends_a_cancellation_email_to_the_user_contact(): void
    {
        ...
        self::assertSame(BookingEmail::TYPE_CANCELLATION, $sent[0]->type);
        self::assertSame('BK-7F3A2C9K', $sent[0]->reference);
        self::assertSame(2, $sent[0]->seats);
        self::assertSame(0, $sent[0]->totalAmount);
